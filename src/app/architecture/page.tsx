            ...
            >
              <div className="max-w-[980px] mx-auto px-6">
                ...
                <div className="flex items-start gap-4 sm:gap-6 mb-8">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      <h3 className={`text-[28px] sm:text-[40px] md:text-[48px] font-bold tracking-tight font-sans ${isDark ? 'text-foreground' : 'text-foreground'}`}>
                        {layer.title}
                      </h3>
                ...
                <div className="ml-0 sm:ml-20">
                  <h4 className="text-[12px] font-semibold text-primary uppercase tracking-wider mb-5 font-sans">
                    Key Components
                  </h4>
                ...
                {layer.stubs.length > 0 && (
                  <div className="ml-0 sm:ml-20 mt-8">
                    <h4 className="text-[12px] font-semibold text-warning uppercase tracking-wider mb-4 flex items-center gap-2 font-sans">
