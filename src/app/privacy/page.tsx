...
export default function PrivacyPage() {
 ...
 <div>
 <span className={`text-[12px] tracking-normal uppercase mb-1 block font-mono ${isDark ? 'text-success' : 'text-success'}`}>
 Section {section.number}
 </span>
 <h2 className={`font-sans text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-normal leading-[1.1] ${isDark ? 'text-foreground' : 'text-foreground'}`}>
 {section.title}
 </h2>
 </div>
 </div>
